...
public class MekanismShaders {
    ...
    public static void init() {
        CoreShaderRegistrationCallback.EVENT.register(MekanismShaders::shaderRegistry);
    }

    public static void shaderRegistry(RegistrationContext event) throws IOException {
    ...
    private static void registerShader(RegistrationContext event, ResourceLocation shaderLocation, VertexFormat vertexFormat, ShaderTracker tracker) throws IOException {
        event.register(shaderLocation, vertexFormat, tracker::setInstance);
    }
