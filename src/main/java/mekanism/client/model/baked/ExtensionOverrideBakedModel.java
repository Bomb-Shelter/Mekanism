...
public class ExtensionOverrideBakedModel<T> extends ExtensionBakedModel<T> {
    ...
    public abstract static class ExtendedItemOverrides extends ItemOverrides {
        ...
        protected BakedModel wrap(BakedModel model, ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed, Object modelData,
              BiFunction<BakedModel, Object, ModelDataBakedModel> wrapper) {
